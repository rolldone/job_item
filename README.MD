...
The `upload` subcommand uploads a single file to the Job Manager's file upload endpoint. It is useful for sending artifacts (reports, logs, etc.) produced locally to the Job Manager associated with a task.
